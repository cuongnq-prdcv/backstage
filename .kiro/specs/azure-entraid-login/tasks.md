...
- [x] 1. Add the Microsoft provider dependency
  - [x] 1.1 Add `@backstage/plugin-auth-backend-module-microsoft-provider` to the backend workspace
...
- [x] 2. Implement the pure derivation helper
  - [x] 2.1 Create `deriveMicrosoftUserRef` and the `DeriveOutcome` type
  ...
  - [x] 2.2 Write the property test for outcome by input
  ...
  - [x] 2.3 Write the property test for case-insensitivity and determinism
  ...
  - [x] 2.4 Write example unit tests for the derivation
...
- [x] 3. Implement the custom sign-in resolver
  - [x] 3.1 Build the resolver wiring `deriveMicrosoftUserRef` to token issuance
  ...
  - [x] 3.2 Write unit tests for the resolver's issue and deny paths
...
- [x] 4. Register the Microsoft provider in the backend
  - [x] 4.1 Create `authModuleMicrosoftProvider.ts`
  ...
  - [x] 4.2 Wire the module into `packages/backend/src/index.ts`
  ...
  - [x] 4.3 Write the module smoke test
...
- [x] 5. Configure the provider in app-config
  - [x] 5.1 Add the `microsoft` development block in `app-config.yaml`
  ...
  - [x] 5.2 Add the `microsoft` production block in `app-config.production.yaml`
  ...
  - [x] 5.3 Write config-shape and no-literal-value tests
...
- [x] 6. Checkpoint - Ensure backend build and tests pass
  - Run `yarn tsc`, `yarn workspace backend test`, and `yarn lint`. Ensure all pass; ask the user if questions arise.

- [x] 7. Add the Microsoft sign-in option to the frontend
  - [x] 7.1 Add the Microsoft provider entry in `SignInPage.tsx`
  ...
  - [x] 7.2 Extend `SignInPage.test.tsx`
...
- [x] 8. Document the environment variables
  - [x] 8.1 Update the README Environment variables section
